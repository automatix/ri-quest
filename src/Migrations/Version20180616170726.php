 ...
 */
final class Version20180616170726 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE answers (id INT UNSIGNED AUTO_INCREMENT NOT NULL, question_id INT UNSIGNED DEFAULT NULL, text VARCHAR(50) NOT NULL, type VARCHAR(255) DEFAULT NULL, INDEX fk_answer_question_idx (question_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE concrete_processes (id INT UNSIGNED AUTO_INCREMENT NOT NULL, parent_id INT UNSIGNED DEFAULT NULL, type VARCHAR(255) NOT NULL, state VARCHAR(255) DEFAULT \'unknown\' NOT NULL, INDEX fk_concrete_process_concrete_process_idx (parent_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE content_blocks (id INT UNSIGNED AUTO_INCREMENT NOT NULL, message_id INT UNSIGNED DEFAULT NULL, `order` TINYINT(1) DEFAULT NULL, INDEX fk_content_block_message_idx (message_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE info_steps (id INT UNSIGNED NOT NULL, step_type VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE messages (id INT UNSIGNED AUTO_INCREMENT NOT NULL, message_stack_id INT UNSIGNED DEFAULT NULL, `order` TINYINT(1) DEFAULT NULL, INDEX fk_message_message_stack_idx (message_stack_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE message_stacks (id INT UNSIGNED AUTO_INCREMENT NOT NULL, type VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE place_steps (id INT UNSIGNED NOT NULL, step_type VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE processes (id INT UNSIGNED AUTO_INCREMENT NOT NULL, parent_id INT UNSIGNED DEFAULT NULL, `order` TINYINT(1) NOT NULL, INDEX fk_process_process_idx (parent_id), UNIQUE INDEX uq_unique_order_for_process (parent_id, `order`), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE quests (id INT UNSIGNED AUTO_INCREMENT NOT NULL, concrete_process_id INT UNSIGNED DEFAULT NULL, scenario_id INT UNSIGNED DEFAULT NULL, INDEX fk_quest_scenario_idx (scenario_id), INDEX fk_quest_concrete_process_idx (concrete_process_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE tasks (id INT UNSIGNED AUTO_INCREMENT NOT NULL, task_step_id INT UNSIGNED DEFAULT NULL, INDEX fk_task_task_step_idx (task_step_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE task_steps (id INT UNSIGNED NOT NULL, step_type VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
