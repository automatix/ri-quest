 ...
 */
final class Version20180628211853 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE answers (id INT UNSIGNED AUTO_INCREMENT NOT NULL, question_id INT UNSIGNED NOT NULL, text VARCHAR(50) NOT NULL, `type` VARCHAR(255) NOT NULL, date_created DATETIME NOT NULL, date_modified DATETIME NOT NULL, INDEX fk_answer_question_idx (question_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE content_blocks (id INT UNSIGNED AUTO_INCREMENT NOT NULL, message_id INT UNSIGNED NOT NULL, `order` INT NOT NULL, date_created DATETIME NOT NULL, date_modified DATETIME NOT NULL, `type` VARCHAR(255) NOT NULL, INDEX fk_content_block_message_idx (message_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE messages (id INT UNSIGNED AUTO_INCREMENT NOT NULL, message_stack_id INT UNSIGNED NOT NULL, `order` INT NOT NULL, date_created DATETIME NOT NULL, date_modified DATETIME NOT NULL, INDEX fk_message_message_stack_idx (message_stack_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE semantical_message_stacks (id INT UNSIGNED NOT NULL, semantic VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE question_tasks (id INT UNSIGNED NOT NULL, text VARCHAR(50) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
