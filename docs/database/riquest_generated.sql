...
-- Schema riquest
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `riquest` DEFAULT CHARACTER SET utf8mb4 ;
USE `riquest` ;
...
CREATE TABLE IF NOT EXISTS `riquest`.`task_steps` (
  ...
  PRIMARY KEY (`id`),
  CONSTRAINT `FK_F3861152BF396750`
    FOREIGN KEY (`id`)
    REFERENCES `riquest`.`processes` (`id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
...
CREATE TABLE IF NOT EXISTS `riquest`.`question_tasks` (
  `id` INT(10) UNSIGNED NOT NULL,
  `text` VARCHAR(50) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci' NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  CONSTRAINT `FK_60B37493BF396750`
    FOREIGN KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `riquest`.`answers` (
  ...
  `text` VARCHAR(50) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci' NOT NULL,
...
CREATE TABLE IF NOT EXISTS `riquest`.`semantical_message_stacks` (
  `id` INT(10) UNSIGNED NOT NULL,
  `semantic` VARCHAR(255) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci' NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  CONSTRAINT `FK_1F915555BF396750`
    FOREIGN KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `riquest`.`answers_semantical_message_stacks` (
  ...
  INDEX `IDX_E8647BEAAA334807` (`answer_id` ASC),
...
CREATE TABLE IF NOT EXISTS `riquest`.`audio_content_blocks` (
  `id` INT(10) UNSIGNED NOT NULL,
  `src` VARCHAR(1000) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci' NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  CONSTRAINT `FK_E718E1DEBF396750`
    FOREIGN KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `riquest`.`concrete_processes` (
  ...
  `state` VARCHAR(255) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci' NOT NULL DEFAULT 'unknown',
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `riquest`.`fun_tasks` (
  `id` INT(10) UNSIGNED NOT NULL,
  PRIMARY KEY (`id`),
  CONSTRAINT `FK_9DEB6C64BF396750`
    FOREIGN KEY (`id`)
    REFERENCES `riquest`.`tasks` (`id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
...
CREATE TABLE IF NOT EXISTS `riquest`.`image_content_blocks` (
  `id` INT(10) UNSIGNED NOT NULL,
  `src` VARCHAR(1000) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci' NOT NULL,
  PRIMARY KEY (`id`),
  CONSTRAINT `FK_314D32BEBF396750`
    FOREIGN KEY (`id`)
    REFERENCES `riquest`.`content_blocks` (`id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
...
CREATE TABLE IF NOT EXISTS `riquest`.`info_steps` (
  ...
  `step_type` VARCHAR(255) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci' NOT NULL,
  PRIMARY KEY (`id`),
  CONSTRAINT `FK_3E7BCF87BF396750`
    FOREIGN KEY (`id`)
    REFERENCES `riquest`.`processes` (`id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
...
CREATE TABLE IF NOT EXISTS `riquest`.`link_content_blocks` (
  `id` INT(10) UNSIGNED NOT NULL,
  `text` VARCHAR(1000) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci' NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  CONSTRAINT `FK_B2AF2197BF396750`
    FOREIGN KEY (`id`)
    REFERENCES `riquest`.`content_blocks` (`id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `riquest`.`migration_versions` (
...
CREATE TABLE IF NOT EXISTS `riquest`.`place_steps` (
  ...
  `step_type` VARCHAR(255) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci' NOT NULL,
  PRIMARY KEY (`id`),
  CONSTRAINT `FK_9D541151BF396750`
    FOREIGN KEY (`id`)
    REFERENCES `riquest`.`processes` (`id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
...
CREATE TABLE IF NOT EXISTS `riquest`.`pois` (
  `id` INT(10) UNSIGNED NOT NULL,
  PRIMARY KEY (`id`),
  CONSTRAINT `FK_74C303F5BF396750`
    FOREIGN KEY (`id`)
    REFERENCES `riquest`.`processes` (`id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
...
CREATE TABLE IF NOT EXISTS `riquest`.`process_message_stacks` (
  `id` INT(10) UNSIGNED NOT NULL,
  `processx` VARCHAR(255) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci' NOT NULL,
  `state` VARCHAR(255) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci' NOT NULL,
  `event` VARCHAR(255) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci' NOT NULL,
  PRIMARY KEY (`id`),
  CONSTRAINT `FK_5C53BA4EBF396750`
    FOREIGN KEY (`id`)
    REFERENCES `riquest`.`message_stacks` (`id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
...
CREATE TABLE IF NOT EXISTS `riquest`.`process_process_message_stack` (
  ...
  INDEX `IDX_12130B1C7EC2F574` (`process_id` ASC),
...
CREATE TABLE IF NOT EXISTS `riquest`.`scenarios` (
  `id` INT(10) UNSIGNED NOT NULL,
  PRIMARY KEY (`id`),
  CONSTRAINT `FK_9338D025BF396750`
    FOREIGN KEY (`id`)
    REFERENCES `riquest`.`processes` (`id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
...
CREATE TABLE IF NOT EXISTS `riquest`.`tasks_semantical_message_stacks` (
  ...
  INDEX `IDX_40B34EEA8DB60186` (`task_id` ASC),
...
CREATE TABLE IF NOT EXISTS `riquest`.`text_content_blocks` (
  ...
  PRIMARY KEY (`id`),
  CONSTRAINT `FK_6C1D09C3BF396750`
    FOREIGN KEY (`id`)
    REFERENCES `riquest`.`content_blocks` (`id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
...
CREATE TABLE IF NOT EXISTS `riquest`.`video_content_blocks` (
  ...
  `src` VARCHAR(1000) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci' NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  CONSTRAINT `FK_8009AF54BF396750`
    FOREIGN KEY (`id`)
    REFERENCES `riquest`.`content_blocks` (`id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
